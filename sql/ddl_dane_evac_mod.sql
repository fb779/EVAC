...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-10-2016 a las 23:39:54
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Actividades de la empresa';
...
CREATE TABLE `auditoria` (
  ...
  `nom_var` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `valor_anterior` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `valor_actual` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `capitulo_i` (
  ...
  `i1r3c9` text COLLATE utf8_unicode_ci,
...
CREATE TABLE `capitulo_i_displab` (
  ...
  `C1_nordemp` bigint(10) UNSIGNED NOT NULL,
  `vigencia` mediumint(4) UNSIGNED NOT NULL,
  `i1r2c1` tinyint(10) DEFAULT NULL,
  `i1r2c2` tinyint(10) DEFAULT NULL,
  `i1r2c3` tinyint(10) DEFAULT NULL,
  ...
  `i1r2c11` tinyint(10) DEFAULT NULL,
  `i1r2c12` tinyint(10) DEFAULT NULL,
  `i1r2c13` tinyint(10) DEFAULT NULL,
  `i1r2c14` tinyint(10) DEFAULT NULL,
  `i1r2c15` tinyint(10) DEFAULT NULL,
  `i1r2c16` tinyint(10) DEFAULT NULL,
  `i1r2c17` tinyint(10) DEFAULT NULL,
  `i1r2c18` tinyint(10) DEFAULT NULL,
  `i1r2c19` tinyint(10) DEFAULT NULL,
  `i1r2c20` tinyint(10) DEFAULT NULL,
  `i1r2c21` varchar(200) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `caratula` (
  ...
  `telenotific` varchar(12) COLLATE utf8_unicode_ci DEFAULT NULL,
  `faxnotific` varchar(12) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `emailnotif` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  `webnotif` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  `emailres` varchar(80) COLLATE utf8_unicode_ci NOT NULL COMMENT 'email de la persona que diligencia el formulario',
  `lgg` char(10) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `casos` (
  ...
  `condicion` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT 'formula',
  `descripcion` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT 'Descripcion caso'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `ciiu3` (
  `CODIGO` varchar(4) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  `DESCRIP` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `control` (
  ...
  `usuariodt` char(8) COLLATE utf8_unicode_ci NOT NULL,
  `usuarioss` char(8) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `acceso` char(3) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Indica a que rol se le permite acceso a modificaci├│n (FU(fuente), CR(cr├¡tico), DC(dane central))'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `devoluciones` (
  ...
  `observa` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT 'Observaci├│n de la devoluci├│n',
  `codsede` int(2) NOT NULL DEFAULT '0' COMMENT 'Sede fuente',
  `tipo` char(5) COLLATE utf8_unicode_ci NOT NULL COMMENT '(DV)-Devuelto (RV)-Reenviado',
  `coddev` char(7) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'Quien devuelve el formulario',
  `codcrit` char(8) COLLATE utf8_unicode_ci NOT NULL COMMENT 'C├│digo de cr├¡tico',
...
CREATE TABLE `divipola` (
  ...
  `ndpto` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `edit_eam` (
  ...
  `enmarcha` char(2) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Proyectos en marcha',
  `desc_novedad` char(80) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Descripci├│n novedad'
...
CREATE TABLE `edit_eas` (
  ...
  `personal` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Personal Abuales',
  `ingresos` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Ingresos Anuales',
  `otrosing` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Otros ingresos anuales',
  `maqyeq` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Maq. y Eq. Anuales',
  `eqinf` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Eq. Info. Anuales',
  `software` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Software Anuales',
  `pertot_edit_a1` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Personal Edit P. anterior',
  `pertot_edit_a2` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Personal Edit P. anterior',
  `vtas_edit_a1` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Vtas Edit P. Anterior',
  `pertot_edit_i1` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Personal Industria P. Anterior',
  `pertot_edit_i2` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Personal Industria P. Anterior',
  `vtas_edit_i1` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Vtas Edit Industria P. Anterior',
  `enmarcha` char(2) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Proyectos en marcha',
...
CREATE TABLE `estados` (
  ...
  `desc_estado` varchar(45) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `novedades` (
  ...
  `desc_novedad` varchar(45) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `observaciones` (
  ...
  `usuario` char(8) COLLATE utf8_unicode_ci NOT NULL COMMENT 'usuario que ingresa la observacion',
  `capitulo` tinyint(1) NOT NULL COMMENT 'capitulo',
  `observacion` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT 'Observacion',
...
CREATE TABLE `regionales` (
  ...
  `asistente` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `soportes` (
  ...
  `soporte_nombre` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `soporte_peso` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `soporte_tipo` varchar(25) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `tipoperiodo` (
  ...
  `codPeriodo` varchar(45) CHARACTER SET utf8 NOT NULL,
  `descperiodo` varchar(45) CHARACTER SET utf8 NOT NULL
...
CREATE TABLE `usuarios` (
  `ident` char(20) COLLATE utf8_unicode_ci NOT NULL,
  `nombre` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  `tipo` char(2) COLLATE utf8_unicode_ci NOT NULL,
  `numemp` bigint(10) NOT NULL,
  `clave` char(16) COLLATE utf8_unicode_ci NOT NULL,
  `fcrea` date NOT NULL,
  `fexpi` date NOT NULL,
...
--
ALTER TABLE `capitulo_i_displab`
  MODIFY `id_displab` bigint(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
