<?php
	...
	$anterior = $vig -1;
	$direccion = 'http://192.168.1.200/dimpe/industria/evac';
	include '../conecta.php';
	...
	foreach ($qCorreo AS $lcorreo) {
		...
		Ciudad<br><br><br><br>
		Asunto:   Notificaci&oacute;n encuesta de vacantes - EVAC<br><br><br><br>
		...
		rector del Sistema Estad&iacute;stico Nacional, asegura la producci&oacute;n de estad&iacute;sticas b&aacute;sicas y estrat&eacute;gicas
		para la toma de decisiones en el desarrollo econ&oacute;mico y social del pa&iacute;s</p>
		<p style = 'text-align: justify; font-size: 14px'>Con el fin de cumplir con este objetivo, el DANE desarrolla una medici&oacute;n con periodicidad
		trimestral de las diferentes vacantes abiertas, en el sector de industria, comercio y servicios a trav&eacute;s de la
		<b>Encuesta de vacantes - EVAC</b>. Esta encuesta tiene como objetivo general, Recolectar, consolidar, procesar y proporcionar información relativa a la demanda laboral de los sectores Industria, Comercio y Servicios.</p>
		<p style = 'text-align: justify; font-size: 14px'>Con el prop&oacute;sito de facilitar  el reporte de la informaci&oacute;n
		correspondiente al trimestre " . $nomperiodo . ", el Dane  tiene a su disposici&oacute;n un formulario electr&oacute;nico al cual podr&aacute; ingresar
		luego de <a style='font-size: 16px' href='". $direccion ."/administracion/correosctl.php?b04f60=" . $nit . "&5f458dc406e8=" . $dv . "&b0a6a243b5fe=" . $nordemp . "&per=" . $vig . "'><b>GENERAR SU USUARIO Y CONTRASE&Ntilde;A</b></a>.</p>
		<p style = 'text-align: justify; font-size: 14px'>A trav&eacute;s del siguiente link <a style='font-size: 16px' href='". $direccion ."/'><b>Formulario Encuesta de vacantes - EVAC</b></a>,
		...
		ASISTENTE T&Eacute;CNICO<br>ENCUESTA DE VACANTES - EVAC<br>" . $dato_region['nombre'] . "<br>" . $dato_region['direccion'] . "<br>" . $dato_region['telefono'] . "<br>" . $dato_region['correo'] .
		"</td></tr></table>";
