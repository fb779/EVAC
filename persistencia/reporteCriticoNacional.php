    ...
    // if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
            ...
            if ( array_key_exists($consulta, $estadosCons) ){
                ...
                */
                ...
                $query = "SELECT ca.nordemp, ca.nombre, di.ndpto, di.nmuni, ca.ciiu3, re.nombre as codireg, re.nombre as codis, IFNULL('1-forzoso','2-Probabilistico') AS inclusion, nv.desc_novedad, ct.estado, (SELECT if (count(nordemp)>0,'Si','No') FROM devoluciones WHERE nordemp = ca.nordemp) AS devolucion, (SELECT fecha FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS fecha, (SELECT datediff(curdate(),fecha) FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS dias, (SELECT nombre FROM usuarios WHERE ident = ct.usuario) AS critico FROM caratula AS ca INNER JOIN control AS ct ON ca.nordemp = ct.nordemp INNER JOIN divipola AS di ON ca.depto = di.dpto AND ca.mpio = di.muni INNER JOIN regionales AS re ON ct.codsede = re.codis INNER JOIN novedades AS nv ON ct.novedad = nv.idnovedades WHERE ct.codsede = '$sede' AND ct.estado in ($estados) AND ct.novedad NOT IN ($novedades)";
            }

            if ( $consulta == $especialesCons['dv']){
                $query = "SELECT ca.nordemp, ca.nombre, di.ndpto, di.nmuni, ca.ciiu3, re.nombre as codireg, re.nombre as codis, IFNULL('1-forzoso','2-Probabilistico') AS inclusion, nv.desc_novedad, ct.estado, (SELECT if (count(nordemp)>0,'Si','No') FROM devoluciones WHERE nordemp = ca.nordemp) AS devolucion, (SELECT fecha FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS fecha, (SELECT datediff(curdate(),fecha) FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS dias, (SELECT nombre FROM usuarios WHERE ident = ct.usuario) AS critico FROM caratula AS ca INNER JOIN control AS ct ON ca.nordemp = ct.nordemp INNER JOIN divipola AS di ON ca.depto = di.dpto AND ca.mpio = di.muni INNER JOIN regionales AS re ON ct.codsede = re.codis INNER JOIN novedades AS nv ON ct.novedad = nv.idnovedades WHERE ct.codsede = '$sede' AND ct.estado in ($estados) AND ct.novedad NOT IN ($novedades) AND ca.nordemp IN (SELECT dv.nordemp FROM devoluciones AS dv WHERE dv.vigencia = $vig AND dv.codsede = '$sede' AND tipo IN ('DEV'))";
            }

            if ( $consulta == $especialesCons['hdv']){
                $query = "SELECT ca.nordemp, ca.nombre, di.ndpto, di.nmuni, ca.ciiu3, re.nombre as codireg, re.nombre as codis, IFNULL('1-forzoso','2-Probabilistico') AS inclusion, nv.desc_novedad, ct.estado, (SELECT if (count(nordemp)>0,'Si','No') FROM devoluciones WHERE nordemp = ca.nordemp) AS devolucion, (SELECT fecha FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS fecha, (SELECT datediff(curdate(),fecha) FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS dias, (SELECT nombre FROM usuarios WHERE ident = ct.usuario) AS critico FROM caratula AS ca INNER JOIN control AS ct ON ca.nordemp = ct.nordemp INNER JOIN divipola AS di ON ca.depto = di.dpto AND ca.mpio = di.muni INNER JOIN regionales AS re ON ct.codsede = re.codis INNER JOIN novedades AS nv ON ct.novedad = nv.idnovedades WHERE ct.codsede = '$sede' AND ct.estado in ($estados) AND ct.novedad NOT IN ($novedades) AND ca.nordemp IN (SELECT DISTINCT(nordemp) FROM devoluciones WHERE vigencia = $vig AND codsede = '$sede' AND tipo IN ('DEV', 'DVR'))";
            }

            if ( $consulta == $especialesCons['nv']){
                $query = "SELECT ca.nordemp, ca.nombre, di.ndpto, di.nmuni, ca.ciiu3, re.nombre as codireg, re.nombre as codis, IFNULL('1-forzoso','2-Probabilistico') AS inclusion, nv.desc_novedad, ct.estado, (SELECT if (count(nordemp)>0,'Si','No') FROM devoluciones WHERE nordemp = ca.nordemp) AS devolucion, (SELECT fecha FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS fecha, (SELECT datediff(curdate(),fecha) FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS dias, (SELECT nombre FROM usuarios WHERE ident = ct.usuario) AS critico FROM caratula AS ca INNER JOIN control AS ct ON ca.nordemp = ct.nordemp INNER JOIN divipola AS di ON ca.depto = di.dpto AND ca.mpio = di.muni INNER JOIN regionales AS re ON ct.codsede = re.codis INNER JOIN novedades AS nv ON ct.novedad = nv.idnovedades WHERE ct.codsede = '$sede' AND ct.novedad in ($novedades)";
            }

            if ( $consulta == $especialesCons['de']){
                $query = "SELECT ca.nordemp, ca.nombre, di.ndpto, di.nmuni, ca.ciiu3, re.nombre as codireg, re.nombre as codis, IFNULL('1-forzoso','2-Probabilistico') AS inclusion, nv.desc_novedad, ct.estado, (SELECT if (count(nordemp)>0,'Si','No') FROM devoluciones WHERE nordemp = ca.nordemp) AS devolucion, (SELECT fecha FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS fecha, (SELECT datediff(curdate(),fecha) FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS dias, (SELECT nombre FROM usuarios WHERE ident = ct.usuario) AS critico FROM caratula AS ca INNER JOIN control AS ct ON ca.nordemp = ct.nordemp INNER JOIN divipola AS di ON ca.depto = di.dpto AND ca.mpio = di.muni INNER JOIN regionales AS re ON ct.codsede = re.codis INNER JOIN novedades AS nv ON ct.novedad = nv.idnovedades WHERE ct.codsede = '$sede' AND ct.estado in (0,1,2,3,4) AND ct.novedad NOT IN ($novedades)";
            }

            if ( $consulta == $especialesCons['re']){
                $query = "SELECT ca.nordemp, ca.nombre, di.ndpto, di.nmuni, ca.ciiu3, re.nombre as codireg, re.nombre as codis, IFNULL('1-forzoso','2-Probabilistico') AS inclusion, nv.desc_novedad, ct.estado, (SELECT if (count(nordemp)>0,'Si','No') FROM devoluciones WHERE nordemp = ca.nordemp) AS devolucion, (SELECT fecha FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS fecha, (SELECT datediff(curdate(),fecha) FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS dias, (SELECT nombre FROM usuarios WHERE ident = ct.usuario) AS critico FROM caratula AS ca INNER JOIN control AS ct ON ca.nordemp = ct.nordemp INNER JOIN divipola AS di ON ca.depto = di.dpto AND ca.mpio = di.muni INNER JOIN regionales AS re ON ct.codsede = re.codis INNER JOIN novedades AS nv ON ct.novedad = nv.idnovedades WHERE ct.codsede = '$sede' AND (ct.estado in (5,6) OR ct.novedad in ($novedades))";
            }
