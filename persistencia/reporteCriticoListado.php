<?php
    // if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
            ...
            if ( $consulta == $especialesCons['dv']){
                $query = "SELECT ca.nordemp, ca.nombre, di.ndpto, di.nmuni, ca.ciiu3, re.codireg, re.codis, IFNULL('1-forzoso','2-Probabilistico') AS inclusion, ct.novedad, ct.estado, (SELECT if (count(nordemp)>0,'Si','No') FROM devoluciones WHERE nordemp = ca.nordemp) AS devolucion, (SELECT fecha FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS fecha, (SELECT datediff(curdate(),fecha) FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS dias, (SELECT nombre FROM usuarios WHERE ident = '$usuario') AS critico FROM caratula AS ca INNER JOIN control AS ct ON ca.nordemp = ct.nordemp INNER JOIN divipola AS di ON ca.depto = di.dpto AND ca.mpio = di.muni INNER JOIN regionales AS re ON ct.codsede = re.codis WHERE $campUsuario = '$usuario' AND ct.estado in (4,5,6) AND ca.nordemp IN (SELECT DISTINCT(nordemp) FROM devoluciones WHERE $campDevUsu = '$usuario' AND tipo IN ('DEV'))";
            }

            if ( $consulta == $especialesCons['hdv']){
                $query = "SELECT ca.nordemp, ca.nombre, di.ndpto, di.nmuni, ca.ciiu3, re.codireg, re.codis, IFNULL('1-forzoso','2-Probabilistico') AS inclusion, ct.novedad, ct.estado, (SELECT if (count(nordemp)>0,'Si','No') FROM devoluciones WHERE nordemp = ca.nordemp) AS devolucion, (SELECT fecha FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS fecha, (SELECT datediff(curdate(),fecha) FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS dias, (SELECT nombre FROM usuarios WHERE ident = '$usuario') AS critico FROM caratula AS ca INNER JOIN control AS ct ON ca.nordemp = ct.nordemp INNER JOIN divipola AS di ON ca.depto = di.dpto AND ca.mpio = di.muni INNER JOIN regionales AS re ON ct.codsede = re.codis WHERE $campUsuario = '$usuario' AND ct.estado in (4,5,6) AND ca.nordemp IN (SELECT DISTINCT(nordemp) FROM devoluciones WHERE $campDevUsu = '$usuario' AND tipo IN ('DEV', 'DVR'))";
            }

            if ( $consulta == $especialesCons['nv']){
                $query = "SELECT ca.nordemp, ca.nombre, di.ndpto, di.nmuni, ca.ciiu3, re.codireg, re.codis, IFNULL('1-forzoso','2-Probabilistico') AS inclusion, ct.novedad, ct.estado, (SELECT if (count(nordemp)>0,'Si','No') FROM devoluciones WHERE nordemp = ca.nordemp) AS devolucion, (SELECT fecha FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS fecha, (SELECT datediff(curdate(),fecha) FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS dias, (SELECT nombre FROM usuarios WHERE ident = '$usuario') AS critico FROM caratula AS ca INNER JOIN control AS ct ON ca.nordemp = ct.nordemp INNER JOIN divipola AS di ON ca.depto = di.dpto AND ca.mpio = di.muni INNER JOIN regionales AS re ON ct.codsede = re.codis WHERE $campUsuario = '$usuario' AND ct.novedad in ($novedades)";
            }

            if ( $consulta == $especialesCons['de']){
                $query = "SELECT ca.nordemp, ca.nombre, di.ndpto, di.nmuni, ca.ciiu3, re.codireg, re.codis, IFNULL('1-forzoso','2-Probabilistico') AS inclusion, ct.novedad, ct.estado, (SELECT if (count(nordemp)>0,'Si','No') FROM devoluciones WHERE nordemp = ca.nordemp) AS devolucion, (SELECT fecha FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS fecha, (SELECT datediff(curdate(),fecha) FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS dias, (SELECT nombre FROM usuarios WHERE ident = '$usuario') AS critico FROM caratula AS ca INNER JOIN control AS ct ON ca.nordemp = ct.nordemp INNER JOIN divipola AS di ON ca.depto = di.dpto AND ca.mpio = di.muni INNER JOIN regionales AS re ON ct.codsede = re.codis WHERE $campUsuario = '$usuario' AND ct.estado in (0,1,2,3,4)";
            }

            if ( $consulta == $especialesCons['re']){
                $query = "SELECT ca.nordemp, ca.nombre, di.ndpto, di.nmuni, ca.ciiu3, re.codireg, re.codis, IFNULL('1-forzoso','2-Probabilistico') AS inclusion, ct.novedad, ct.estado, (SELECT if (count(nordemp)>0,'Si','No') FROM devoluciones WHERE nordemp = ca.nordemp) AS devolucion, (SELECT fecha FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS fecha, (SELECT datediff(curdate(),fecha) FROM devoluciones WHERE nordemp = ca.nordemp AND tipo = 'DVR' ORDER BY fecha DESC LIMIT 1) AS dias, (SELECT nombre FROM usuarios WHERE ident = '$usuario') AS critico FROM caratula AS ca INNER JOIN control AS ct ON ca.nordemp = ct.nordemp INNER JOIN divipola AS di ON ca.depto = di.dpto AND ca.mpio = di.muni INNER JOIN regionales AS re ON ct.codsede = re.codis WHERE $campUsuario = '$usuario' AND ct.estado in (5,6) AND ca.nordemp NOT IN (SELECT DISTINCT(nordemp) FROM devoluciones WHERE $campDevUsu = '$usuario' AND tipo IN ('DEV', 'DVR'))";
            }
