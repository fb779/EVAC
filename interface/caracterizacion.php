		...
		<div id="caracterizacion" class="text-center hidden">
			...
			<div class="container-fluid small">
				<div class="form-group form-group-sm col-xs-12 col-sm-3 ">
					...
					<div class='input-group input-group-sm'>
						...
						<input type='text' class='form-control input-sm text-right validar solo-decimales' id='' name='i1r2c' maxlength="11" value = "<?php //echo $row['i1r2c']?>" maxlength="11" placeholder="Valor digitado en pesos" required />
					</div>
				</div>
				<div class="col-xs-12 col-sm-1"></div>
				<div class="form-group form-group-sm col-xs-12 col-sm-3 ">
			...
			<div class="container-fluid small">
				<div class="col-xs-12 text-left">
					<label class="control-label" >De las vacantes NO cubiertas ¿Cuáles fueron las causas?</label>
				</div>
